...
folder = '../dataDictionary/dhis2_dictionary/Formulas/Malawi/'
...
```{r national_monthly_confirmed_cases , dpi=300 , out.height=5, out.width=8}

  datasetTS.0 %>% 
       autoplot( confCases   ) +
       labs( title =  'Confirmed malaria cases in children <5 yrs of age' ,
             y = 'Cases' , x = 'Month' ) +
       guides( color = FALSE ) +
...
```{r fig.height=5, fig.width=8, , dpi=300, out.height=5, out.width=8}

  datasetTS.0 %>% 
       
  autoplot( confCases , color = 'brown' , size = 1  ) +
 ...
 labs( title =  'Following Mass Bednet Distribution, Malaria Cases Declined in 2019' ,
        subtitle =  'Confirmed malaria cases in children <5 yrs of age' ,
        caption = 'Cases diagnosed either by health facilities or community health workers' , 
        x = 'Month' , 
        y = 'Cases (Millions)\n' )
...
fit.train.0.cross = train.0.cross %>% 
    model( 
