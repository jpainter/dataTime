...
Rainfall reduced in 2016-2017.  In 2016, rain way down except for northern zone. In 2017, ~50% reduction in all distracts.  
...
datasetTS.3 %>% autoplot( avg_month  ) %>%
  plotly::ggplotly()
...
pred.3  = fit.train.3.lo[ c(1:15, 18:28) ,] %>%
