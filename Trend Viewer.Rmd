...
splitLayout( cellWidths = c("25%", "75%") ,
               ...
               checkboxInput( "dataset_merge", label ='Merge all datasets', value = FALSE ) ,
 
    div(id = "expr-container",  
       selectInput( "merge", label ='Merge datasets with selected dataElements/Categories (averages values when reported through multiple datasets)', 
              choices = NULL  ,
              selected = 1 ,
              width = "100%" ,
              multiple = TRUE ,
...
trendData = reactive({
  ...
  if (input$selected & num_facilities() > 1 ){
    .d = .d %>% filter( Selected ==  'Reporting Each Month'  )
  } 
